...
```bash
node /app/cli/skill-runner.js --skill scheduling --params '{"mode":"cron","schedule":{"expression":"0 9 * * *"},"task":{"skill":"web-search","parameters":{"query":"daily news"}}}'
```
...
```bash
node /app/cli/skill-runner.js --skill scheduling --params '{
  "mode": "cron",
