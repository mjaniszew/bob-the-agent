...
```bash
node /app/cli/skill-runner.js --skill notifications --params '{"channels":[{"type":"discord","webhook_url":"https://discord.com/api/webhooks/..."}],"message":{"title":"Alert","body":"Task completed"}}'
```
...
```bash
node /app/cli/skill-runner.js --skill notifications --params '{
